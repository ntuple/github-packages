...
exports.condtionalView = exports.DefaultView = exports["default"] = void 0;
...
var _default = {
  component: _MultiTextFields["default"],
...
var DefaultView = function DefaultView() {
  ...
  var formik = {
    ...
    getFieldProps: (0, _addonActions.action)('name'),
    handleChange: (0, _addonActions.action)('Value Change')
  };
  return /*#__PURE__*/_react["default"].createElement(_MultiTextFields["default"], {
    formik: formik,
    name: question.name,
...
var condtionalView = function condtionalView() {
  var question = {
...
exports.condtionalView = condtionalView;